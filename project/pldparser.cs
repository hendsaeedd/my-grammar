...
namespace com.calitha.goldparser
{
    ...
    enum SymbolConstants : int
    {
        ...
        SYMBOL_FOR_STAT   = 40, // <for_stat>
        SYMBOL_ID2        = 41, // <id>
        SYMBOL_IF_STAT    = 42, // <if_stat>
        SYMBOL_OP         = 43, // <op>
        SYMBOL_PROGRAM    = 44, // <program>
        SYMBOL_STAT_LIST  = 45, // <stat_list>
        SYMBOL_STEP       = 46, // <step>
        SYMBOL_TERM       = 47  // <term>
    };
    ...
    enum RuleConstants : int
    {
        ...
        RULE_IF_STAT_IF_LPAREN_RPAREN_START_END                 = 21, // <if_stat> ::= if '(' <cond> ')' Start <stat_list> End
        RULE_IF_STAT_IF_LPAREN_RPAREN_START_ELSE_END            = 22, // <if_stat> ::= if '(' <cond> ')' Start <stat_list> else <stat_list> End
        RULE_COND                                               = 23, // <cond> ::= <expr> <op> <expr>
        RULE_OP_GT                                              = 24, // <op> ::= '>'
        RULE_OP_LT                                              = 25, // <op> ::= '<'
        RULE_OP_EQEQ                                            = 26, // <op> ::= '=='
        RULE_OP_EXCLAMEQ                                        = 27, // <op> ::= '!='
        RULE_FOR_STAT_FOR_LPAREN_SEMI_SEMI_RPAREN_LBRACE_RBRACE = 28, // <for_stat> ::= for '(' <data> <assign> ';' <cond> ';' <step> ')' '{' <stat_list> '}'
    ...
    public class MyParser
    {
        ...
        public Object CreateObjectFromNonterminal(NonterminalToken token)
        {
            switch (token.Rule.Id)
            {
                ...
                case (int)RuleConstants.RULE_IF_STAT_IF_LPAREN_RPAREN_START_ELSE_END :
                //<if_stat> ::= if '(' <cond> ')' Start <stat_list> else <stat_list> End
                //todo: Create a new object using the stored tokens.
                return null;
